        ...
        <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
            <div class="container-fluid">
                ...
                <a class="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
                    <h3 class="text-success"><img src="https://bytewebster.com/img/logo.png" width="40"><span class="text-info"><?php echo $_SESSION['user']->getName(); ?></span></h3>
                </a>
                <!-- User menu (mobile) -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h3 font-bold mb-0"><?php  ?></span>
                                        </div>
                                        <div class="col-auto">
