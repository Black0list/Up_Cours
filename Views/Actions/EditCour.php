...
<body>
    <div class="container">
        ...
        <form action="/cour/edit" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="Enter the title" value="<?php echo $Object->getTitle() ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" id="title" name="content" placeholder="Enter the title" value="<?php echo $Object->getContent() ?>" required>
            </div>
            ...
            <div>
                ...
                foreach ($Object->getTags() as $value) {
                    array_push($ObjectTags, $value->getName());
                }
